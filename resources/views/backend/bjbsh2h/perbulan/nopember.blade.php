...
@section('desc') Kumpulan data BJBS H2H bulan Nopember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-h2h-maret" class="btn btn-info" role="button">Maret</a>&nbsp;
    ...
    <a href="/admin/bjbs-h2h-nopember" class="btn btn-info active" role="button">Nopember</a>&nbsp;
    <a href="/admin/bjbs-h2h-desember" class="btn btn-info" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/bjbs-h2h-nopember" method="GET">
