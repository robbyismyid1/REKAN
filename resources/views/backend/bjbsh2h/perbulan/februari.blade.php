...
@section('desc') Kumpulan data BJBS H2H bulan Februari @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-h2h-februari" class="btn btn-info active" role="button">Februari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-h2h-februari" method="GET">
