...
@section('desc') Kumpulan data BJBS H2H bulan September @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-h2h-september" class="btn btn-info active" role="button">September</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-h2h-september" method="GET">
