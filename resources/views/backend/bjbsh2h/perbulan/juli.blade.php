...
@section('desc') Kumpulan data BJBS H2H bulan Juli @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-h2h-juli" class="btn btn-info active" role="button">Juli</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-h2h-juli" method="GET">
