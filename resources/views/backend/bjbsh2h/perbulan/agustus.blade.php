...
@section('desc') Kumpulan data BJBS H2H bulan Agustus @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-h2h-agustus" class="btn btn-info active" role="button">Agustus</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-h2h-agustus" method="GET">
