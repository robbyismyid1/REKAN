...
@section('desc') Kumpulan data BJBS H2H bulan Oktober @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-h2h-oktober" class="btn btn-info active" role="button">Oktober</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-h2h-oktober" method="GET">
