...
@section('desc') Kumpulan data BJBS H2H bulan April @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-h2h-april" class="btn btn-info active" role="button">April</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-h2h-april" method="GET">
