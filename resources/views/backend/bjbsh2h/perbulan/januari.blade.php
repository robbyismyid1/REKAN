...
@section('desc') Kumpulan data BJBS H2H bulan Januari @endsection
...
@section('content')
  ...
  <div class="text-center">
    <a href="/admin/bjbs-h2h-januari" class="btn btn-info active" role="button">Januari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-h2h-januari" method="GET">
