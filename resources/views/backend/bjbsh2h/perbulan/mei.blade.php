...
@section('desc') Kumpulan data BJBS H2H bulan Mei @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-h2h-mei" class="btn btn-info active" role="button">Mei</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-h2h-mei" method="GET">
