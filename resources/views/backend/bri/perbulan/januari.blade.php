...
@section('desc') Kumpulan data BRI bulan Januari @endsection
...
@section('content')
  ...
  <div class="text-center">
    <a href="/admin/bri-januari" class="btn btn-info active" role="button">Januari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-januari" method="GET">
