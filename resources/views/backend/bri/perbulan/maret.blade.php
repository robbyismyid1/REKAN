...
@section('desc') Kumpulan data BRI bulan Maret @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-maret" class="btn btn-info active" role="button">Maret</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-maret" method="GET">
  ...
  <br>
    <div class="card">        
          ...
          <br>
            ...
            <div align="right">
                <h5 style="color:black">Data Per Halaman : {{ $maret->perPage() }} <br/></h5>
                <h5 style="color:black">Jumlah Data : {{ number_format($maret->total(), 0, '', '.') }} <br/></h5>
            </div>
      </div>
@endsection 
