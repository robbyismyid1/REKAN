...
@section('desc') Kumpulan data BRI bulan Oktober @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-oktober" class="btn btn-info active" role="button">Oktober</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-oktober" method="GET">
