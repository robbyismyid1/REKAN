...
@section('desc') Kumpulan data BRI bulan Juni @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-juni" class="btn btn-info active" role="button">Juni</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-juni" method="GET">
  ...
  <br>
    <div class="card">        
          ...
          <br>
            ...
            <div align="right">
                <h5 style="color:black">Data Per Halaman : {{ $juni->perPage() }} <br/></h5>
                <h5 style="color:black">Jumlah Data : {{ number_format($juni->total(), 0, '', '.') }} <br/></h5>
            </div>
      </div>
@endsection 
