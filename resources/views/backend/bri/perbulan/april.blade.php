...
@section('desc') Kumpulan data BRI bulan April @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-april" class="btn btn-info active" role="button">April</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-april" method="GET">
  ...
  <br>
    <div class="card">        
          ...
          <br>
            ...
            <div align="right">
                <h5 style="color:black">Data Per Halaman : {{ $april->perPage() }} <br/></h5>
                <h5 style="color:black">Jumlah Data : {{ number_format($april->total(), 0, '', '.') }} <br/></h5>
            </div>
      </div>
@endsection 
