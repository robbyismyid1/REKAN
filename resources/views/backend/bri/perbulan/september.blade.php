...
@section('desc') Kumpulan data BRI bulan September @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-september" class="btn btn-info active" role="button">September</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-september" method="GET">
