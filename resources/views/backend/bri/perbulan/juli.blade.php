...
@section('desc') Kumpulan data BRI bulan Juli @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-juli" class="btn btn-info active" role="button">Juli</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-juli" method="GET">
