...
@section('desc') Kumpulan data BRI bulan Desember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-desember" class="btn btn-info active" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/bri-desember" method="GET">
