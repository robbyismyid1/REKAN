...
@section('desc') Kumpulan data BRI bulan Februari @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-februari" class="btn btn-info active" role="button">Februari</a>&nbsp;
    ...
    <a href="/admin/bri-nopember" class="btn btn-info" role="button">Nopember</a>&nbsp;
    <a href="/admin/bri-desember" class="btn btn-info" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/bri-februari" method="GET">
  ...
  <br>
    <div class="card">        
          ...
          <br>
            ...
            <div align="right">
                <h5 style="color:black">Data Per Halaman : {{ $februari->perPage() }} <br/></h5>
                <h5 style="color:black">Jumlah Data : {{ number_format($februari->total(), 0, '', '.') }} <br/></h5>
            </div>
      </div>
@endsection 
