...
@section('desc') Kumpulan data BRI bulan Mei @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-mei" class="btn btn-info active" role="button">Mei</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-mei" method="GET">
  ...
  <br>
    <div class="card">        
          ...
          <br>
            ...
            <div align="right">
                <h5 style="color:black">Data Per Halaman : {{ $mei->perPage() }} <br/></h5>
                <h5 style="color:black">Jumlah Data : {{ number_format($mei->total(), 0, '', '.') }} <br/></h5>
            </div>
      </div>
@endsection 
