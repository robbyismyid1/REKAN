...
@section('desc') Kumpulan data rekap BTN @endsection
@section('header-2') BTN @endsection


@section('content')

<form class="form-inline" action="/admin/btn-rekap-tahun" method="GET">
  <div class="form-group">
    ...
    <a style="color:black" href="/admin/btn-rekap-tahun" class="btn bg-warning" role="button" aria-pressed="true"><li class="fas fa-arrow-left"></li></li></a>
  </div>
</form>
<br>
