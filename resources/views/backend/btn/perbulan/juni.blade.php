...
@section('desc') Kumpulan data BTN bulan Juni @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-juni" class="btn btn-info active" role="button">Juni</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/btn-juni" method="GET">
