...
@section('desc') Kumpulan data BTN bulan Maret @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-maret" class="btn btn-info active" role="button">Maret</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/btn-maret" method="GET">
