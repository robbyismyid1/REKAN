...
@section('desc') Kumpulan data BTN bulan Oktober @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-oktober" class="btn btn-info active" role="button">Oktober</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/btn-oktober" method="GET">
