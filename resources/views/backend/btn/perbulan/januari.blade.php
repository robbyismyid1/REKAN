...
@section('desc') Kumpulan data BTN bulan Januari @endsection
...
@section('content')
  ...
  <div class="text-center">
    <a href="/admin/btn-januari" class="btn btn-info active" role="button">Januari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/btn-januari" method="GET">
