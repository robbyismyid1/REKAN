...
@section('desc') Kumpulan data BTN bulan Mei @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-mei" class="btn btn-info active" role="button">Mei</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/btn-mei" method="GET">
