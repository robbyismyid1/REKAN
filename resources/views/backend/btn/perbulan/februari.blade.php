...
@section('desc') Kumpulan data BTN bulan Februari @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-februari" class="btn btn-info active" role="button">Februari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/btn-februari" method="GET">
