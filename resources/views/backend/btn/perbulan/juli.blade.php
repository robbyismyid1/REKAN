...
@section('desc') Kumpulan data BTN bulan Juli @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-juli" class="btn btn-info active" role="button">Juli</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/btn-juli" method="GET">
