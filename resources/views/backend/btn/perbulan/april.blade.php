...
@section('desc') Kumpulan data BTN bulan April @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-april" class="btn btn-info active" role="button">April</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/btn-april" method="GET">
