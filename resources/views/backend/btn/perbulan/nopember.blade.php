...
@section('desc') Kumpulan data BTN bulan Nopember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-september" class="btn btn-info" role="button">September</a>&nbsp;
    <a href="/admin/btn-oktober" class="btn btn-info" role="button">Oktober</a>&nbsp;
    <a href="/admin/btn-nopember" class="btn btn-info active" role="button">Nopember</a>&nbsp;
    <a href="/admin/btn-desember" class="btn btn-info" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/btn-nopember" method="GET">
