...
@section('desc') Kumpulan data BTN bulan Desember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-desember" class="btn btn-info active" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/btn-desember" method="GET">
