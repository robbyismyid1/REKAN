...
@section('desc') Kumpulan data BTN bulan Agustus @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/btn-agustus" class="btn btn-info active" role="button">Agustus</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/btn-agustus" method="GET">
