...
@section('desc') Kumpulan data BJBS bulan Juni @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-juni" class="btn btn-info active" role="button">Juni</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-juni" method="GET">
