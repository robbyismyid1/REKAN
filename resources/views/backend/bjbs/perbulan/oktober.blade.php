...
@section('desc') Kumpulan data BJBS bulan Oktober @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-oktober" class="btn btn-info active" role="button">Oktober</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-oktober" method="GET">
