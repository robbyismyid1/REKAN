...
@section('desc') Kumpulan data BJBS bulan Februari @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-februari" class="btn btn-info active" role="button">Februari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-februari" method="GET">
