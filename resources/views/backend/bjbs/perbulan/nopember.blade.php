...
@section('desc') Kumpulan data BJBS bulan Nopember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-juli" class="btn btn-info" role="button">Juli</a>&nbsp;
    ...
    <a href="/admin/bjbs-nopember" class="btn btn-info active" role="button">Nopember</a>&nbsp;
    <a href="/admin/bjbs-desember" class="btn btn-info" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/bjbs-nopember" method="GET">
