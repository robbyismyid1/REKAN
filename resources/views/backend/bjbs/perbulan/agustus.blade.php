...
@section('desc') Kumpulan data BJBS bulan Agustus @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-agustus" class="btn btn-info active" role="button">Agustus</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-agustus" method="GET">
