...
@section('desc') Kumpulan data BJBS bulan Maret @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-maret" class="btn btn-info active" role="button">Maret</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-maret" method="GET">
