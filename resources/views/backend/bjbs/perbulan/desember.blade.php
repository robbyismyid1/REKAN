...
@section('desc') Kumpulan data BJBS bulan Desember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-desember" class="btn btn-info active" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/bjbs-desember" method="GET">
