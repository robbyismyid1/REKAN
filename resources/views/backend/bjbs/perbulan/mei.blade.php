...
@section('desc') Kumpulan data BJBS bulan Mei @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-mei" class="btn btn-info active" role="button">Mei</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-mei" method="GET">
