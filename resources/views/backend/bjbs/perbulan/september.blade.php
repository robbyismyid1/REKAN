...
@section('desc') Kumpulan data BJBS bulan September @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bjbs-september" class="btn btn-info active" role="button">September</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bjbs-september" method="GET">
