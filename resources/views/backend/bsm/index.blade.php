...
@elseif (Auth::user()->role_id == 2)
  @section('button-add')
  <div class="section-header-button">
      <button disabled type="button" class="btn btn-primary" data-toggle="modal" data-target="#create-bsm">Tambah Data</button>
  </div>
  @endsection
@endif
              ...
              <tbody>
                @foreach($bsm as $data)
                    <tr>
                        ...
                        @if (Auth::user()->role_id == 1)
                        <td >
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#edit-bsm" 
                            data-id="{{ $data->id }}" 
                            ...
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-bsm" 
                            data-id="{{ $data->id }}" 
                            data-no_urut="{{ $data->no_urut }}" 
                            data-tanggal_1="{{ $data->tanggal_1 }}" 
                            data-tanggal_2="{{ $data->tanggal_2 }}" 
                        ...
                        @elseif (Auth::user()->role_id == 2)
                        <td >
                            <button disabled type="button" class="btn btn-success" data-toggle="modal" data-target="#edit-bsm" 
                            data-id="{{ $data->id }}" 
                            data-no_urut="{{ $data->no_urut }}" 
                            data-tanggal_1="{{ $data->tanggal_1 }}" 
                            data-tanggal_2="{{ $data->tanggal_2 }}" 
                            ...
                            data-kode_transaksi_id="{{ $data->kode_transaksi->nama }}">
                            <i class="fa fa-pen"></i></button>
                            <button disabled type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-bsm" 
                            data-id="{{ $data->id }}" 
                            data-no_urut="{{ $data->no_urut }}" 
                            data-tanggal_1="{{ $data->tanggal_1 }}" 
                            data-tanggal_2="{{ $data->tanggal_2 }}" 
