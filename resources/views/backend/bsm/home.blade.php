...
<div class="row">
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                <a style="color:black" href="{{ route('bsm.index') }}"><h5 class="card-title"><center>Index BSM</center></h5></a>
                <p class="card-text">Yang isinya adalah kumpulan seluruh data BSM</p>
                <a href="{{ route('bsm.index') }}" class="btn btn-primary">Go</a>
                </div>
          </div>
        </div>
        <div class="col-sm-6">
                    ...
                    <div class="card-deck">
                        <div class="card">
                          ...
                          <div class="card-body">
                            ...
                            <p class="card-text">Rekap data BSM perbulan</p>
                            <ul>
