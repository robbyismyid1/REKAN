...
@section('desc') Kumpulan data BSM bulan Juni @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bsm-juni" class="btn btn-info active" role="button">Juni</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bsm-juni" method="GET">
