...
@section('desc') Kumpulan data BSM bulan Maret @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bsm-maret" class="btn btn-info active" role="button">Maret</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bsm-maret" method="GET">
