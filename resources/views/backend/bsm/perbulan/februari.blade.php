...
@section('desc') Kumpulan data BSM bulan Februari @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bsm-februari" class="btn btn-info active" role="button">Februari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bsm-februari" method="GET">
