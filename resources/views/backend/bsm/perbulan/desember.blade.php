...
@section('desc') Kumpulan data BSM bulan Desember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bsm-desember" class="btn btn-info active" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/bsm-desember" method="GET">
