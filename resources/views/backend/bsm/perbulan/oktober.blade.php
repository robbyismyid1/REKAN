...
@section('desc') Kumpulan data BSM bulan Oktober @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bsm-oktober" class="btn btn-info active" role="button">Oktober</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bsm-oktober" method="GET">
