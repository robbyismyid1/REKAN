...
@section('desc') Kumpulan data BSM bulan Januari @endsection
...
@section('content')
  ...
  <div class="text-center">
    <a href="/admin/bsm-januari" class="btn btn-info active" role="button">Januari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bsm-januari" method="GET">
