...
@section('desc') Kumpulan data BSM bulan April @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bsm-april" class="btn btn-info active" role="button">April</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bsm-april" method="GET">
