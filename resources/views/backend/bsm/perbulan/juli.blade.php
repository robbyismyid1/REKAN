...
@section('desc') Kumpulan data BSM bulan Juli @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bsm-juli" class="btn btn-info active" role="button">Juli</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bsm-juli" method="GET">
