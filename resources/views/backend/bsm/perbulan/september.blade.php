...
@section('desc') Kumpulan data BSM bulan September @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bsm-september" class="btn btn-info active" role="button">September</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bsm-september" method="GET">
