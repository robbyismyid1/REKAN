...
@section('desc') Kumpulan data BSM bulan Nopember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bsm-agustus" class="btn btn-info" role="button">Agustus</a>&nbsp;
    ...
    <a href="/admin/bsm-nopember" class="btn btn-info active" role="button">Nopember</a>&nbsp;
    <a href="/admin/bsm-desember" class="btn btn-info" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/bsm-nopember" method="GET">
