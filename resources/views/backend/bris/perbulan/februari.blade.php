...
@section('desc') Kumpulan data BRI-Syariah bulan Februari @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-syariah-februari" class="btn btn-info active" role="button">Februari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-syariah-februari" method="GET">
