...
@section('desc') Kumpulan data BRI-Syariah bulan Juli @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-syariah-juli" class="btn btn-info active" role="button">Juli</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-syariah-juli" method="GET">
