...
@section('desc') Kumpulan data BRI-Syariah bulan April @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-syariah-april" class="btn btn-info active" role="button">April</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-syariah-april" method="GET">
