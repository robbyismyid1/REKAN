...
@section('desc') Kumpulan data BRI-Syariah bulan September @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-syariah-september" class="btn btn-info active" role="button">September</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-syariah-september" method="GET">
