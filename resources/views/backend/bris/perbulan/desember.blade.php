...
@section('desc') Kumpulan data BRI-Syariah bulan Desember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-syariah-desember" class="btn btn-info active" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/bri-syariah-desember" method="GET">
