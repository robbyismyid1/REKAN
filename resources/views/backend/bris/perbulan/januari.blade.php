...
@section('desc') Kumpulan data BRI-Syariah bulan Januari @endsection
...
@section('content')
  ...
  <div class="text-center">
    <a href="/admin/bri-syariah-januari" class="btn btn-info active" role="button">Januari</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-syariah-januari" method="GET">
