...
@section('desc') Kumpulan data BRI-Syariah bulan Juni @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-syariah-juni" class="btn btn-info active" role="button">Juni</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-syariah-juni" method="GET">
