...
@section('desc') Kumpulan data BRI-Syariah bulan Mei @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-syariah-mei" class="btn btn-info active" role="button">Mei</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-syariah-mei" method="GET">
