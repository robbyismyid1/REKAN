...
@section('desc') Kumpulan data BRI-Syariah bulan Nopember @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-syariah-nopember" class="btn btn-info active" role="button">Nopember</a>&nbsp;
    <a href="/admin/bri-syariah-desember" class="btn btn-info" role="button">Desember</a>
  </div>
  <br>
  <form class="form-inline" action="/admin/bri-syariah-nopember" method="GET">
