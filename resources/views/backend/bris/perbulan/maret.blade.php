...
@section('desc') Kumpulan data BRI-Syariah bulan Maret @endsection
...
@section('content')
  ...
  <div class="text-center">
    ...
    <a href="/admin/bri-syariah-maret" class="btn btn-info active" role="button">Maret</a>&nbsp;
  ...
  <br>
  <form class="form-inline" action="/admin/bri-syariah-maret" method="GET">
